...
|----------|------|-------|-----------------|
| Hashing | 11 | 107 | set_lookup, two_sum_pair, frequency_counting, grouping_by_key, consecutive_sequence, matrix_set_validation |
...
| Design | 4 | 83 | stack_as_queue, doubly_linked_list, cache_design, binary_search_versioned |
